...
thr_1 = Thread(target = write_words, args = (10, 'example_5.txt'))
thr_2 = Thread(target = write_words, args = (30, 'example_6.txt'))
thr_3 = Thread(target = write_words, args = (200, 'example_7.txt'))
thr_4 = Thread(target = write_words, args = (100, 'example_8.txt'))
